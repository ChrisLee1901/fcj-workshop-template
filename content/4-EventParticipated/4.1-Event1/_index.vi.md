...
![Mô hình hoạt động của AI Agent](AWS_profile\fcj-workshop-template\static\images\4-Event\Agent.png "AI Agent Architecture")
...
![Cấu trúc Prompt và Kiến trúc AWS](AWS_profile\fcj-workshop-template\static\images\4-Event\prompt.png "Prompt Engineering & AWS")
...
![Sơ đồ kiến trúc phần cứng và AWS cho dự án AIoT](AWS_profile\fcj-workshop-template\static\images\4-Event\AIot.png "AIoT Smart Locker Architecture")

#### Một số hình ảnh khi tham gia sự kiện
* Thêm các hình ảnh của các bạn tại đây

![Ảnh check-in sự kiện](AWS_profile\fcj-workshop-template\static\images\4-Event\event1a.jpg "Check-in")
![Ảnh chụp cùng diễn giả](AWS_profile\fcj-workshop-template\static\images\4-Event\event1b.jpg "Chụp cùng diễn giả")
